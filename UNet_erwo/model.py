...
class UNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.dec1 = UNetDec(1, 32)
        self.dec2 = UNetDec(32, 64)
        self.dec3 = UNetDec(64, 128)
        self.dec4 = UNetDec(128, 256, dropout=True)
        ...
        self.enc4 = UNetEnc(512, 256, 128)
        self.enc3 = UNetEnc(256, 128, 64)
        self.enc2 = UNetEnc(128, 64, 32)
