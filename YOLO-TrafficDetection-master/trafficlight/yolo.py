...
class YOLO(object):
    ...
    def generate(self):
        ...
        try:
            ...
            # by_name = Ture model.load_weights(weights_path, by_name=True)
        else:
    ...
    def detect_image(self, image,path):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            print('images/traffic/'+path+str(i) + '.jpg')
            cv2.imwrite('images/traffic/'+path+str(i) + '.jpg', img2)
            if color== 'red' or color == 'red2':
                ...
                cv2.putText(imgcv, '{0} {1:.2f}'.format(color, score),
                            ...
                            cv2.LINE_AA)
            # elif color == 'yellow':
            #     cv2.rectangle(imgcv, (left, top), (right, bottom), color=(255, 255, 0),
            #                   lineType=2, thickness=8)
            #     cv2.putText(imgcv, '{0} {1:.2f}'.format(color, score),
            #                 (left, top - 15),
            #                 cv2.FONT_HERSHEY_SIMPLEX,
...
if __name__ == '__main__':
    ...
    yolo = YOLO()
    output = 'images/res00.mp4'
    video_full_path = 'images/test0.mp4'
